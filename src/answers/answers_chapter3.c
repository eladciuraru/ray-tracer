...
static void answer_chapter3(void) {
    ...
    mat4 iden_inv = mat4_inverse(&iden);
    ...
    mat4 mat_inv = mat4_inverse(&mat);
    mat4 res     = mat4_mul(&mat, &mat_inv);
    ...
    // Question 3
    mat4 tran     = mat4_transpose(&mat);
    mat4 tran_inv = mat4_inverse(&tran);
    mat4 inv      = mat4_inverse(&mat);
    mat4 inv_tran = mat4_transpose(&inv);
    ...
    iden.m[1][1] = 23.0f;
    vec4 res_vec = mat4_mul_vec4(&iden, &vec);
