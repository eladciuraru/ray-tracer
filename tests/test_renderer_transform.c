...
void test_vector_translate_transform(void) {
    mat4 tran = mat4_translate(mat4_new_transform(), 5.0f, -3.0f, 2.0f);
...
void test_scale_transform(void) {
    mat4 tran = mat4_scale(mat4_new_transform(), 2.0f, 3.0f, 4.0f);
...
void test_rotation_x_transform(void) {
    ...
    mat4 tran_half = mat4_rotate_x(mat4_new_transform(), (f32) M_PI_4);

    vec4 dest_full = vec4_make_point(0.0f, 0.0f, 1.0f);
    mat4 tran_full = mat4_rotate_x(mat4_new_transform(), (f32) M_PI_2);
...
void test_rotation_y_transform(void) {
    ...
    mat4 tran_half = mat4_rotate_y(mat4_new_transform(), (f32) M_PI_4);

    vec4 dest_full = vec4_make_point(1.0f, 0.0f, 0.0f);
    mat4 tran_full = mat4_rotate_y(mat4_new_transform(), (f32) M_PI_2);
...
void test_rotation_z_transform(void) {
    ...
    mat4 tran_half = mat4_rotate_z(mat4_new_transform(), (f32) M_PI_4);

    vec4 dest_full = vec4_make_point(-1.0f, 0.0f, 0.0f);
    mat4 tran_full = mat4_rotate_z(mat4_new_transform(), (f32) M_PI_2);
