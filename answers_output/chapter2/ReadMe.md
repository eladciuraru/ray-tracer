# Output 1
```c
vec4 velocity = vec4_make_vector(1.0f, 1.8f, 0.0f);
vec4_normalize(&velocity);
vec4_scalar_mul(&velocity, 11.25f);
...
# Output 2
```c
vec4 velocity = vec4_make_vector(2.5f, 2.5f, 0.0f);
...
# Output 3
```c
vec4 velocity = vec4_make_vector(9.0f, 0.5f, 0.0f);
velocity      = vec4_normalize(&velocity);
velocity      = vec4_scalar_mul(&velocity, 10.0f);
